...
def search(
    ...
    *,
    ...
    SQL hits). Pass `project_ids` instead of `project_id` to scope the query
    across a set (e.g. a parent + its children, for sibling-aware recall under
    the one-level subproject hierarchy)."""
    if lazy is None:
        return []
